...
const Dashboard = (() => {
  ...
  const QUICK_LINKS = [
    ...
    { href: 'innovation.html', th: 'นวัตกรรม', en: 'Innovation', desc: 'แนวคิดต่อยอด Bottle Battle', icon: '<path d="M9 18h6M10 22h4M12 2a6 6 0 0 0-4 10.5c.6.6 1 1.6 1 2.5h6c0-.9.4-1.9 1-2.5A6 6 0 0 0 12 2Z"/>' },
